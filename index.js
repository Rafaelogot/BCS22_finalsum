...
let users = [
	{
		email: "rafaelchie@gmail.com",
		password: "musvette",
		isAdmin: true
	},
	{
		email: "apexlegends@yahoo.com",
		password: "wraithislayp",
		isAdmin: false
	},
	{
...
let products = [
	{
		name: "Ps Vita",
		description: "Controlling it easy",
		price: 55000,
		isActive: true,
	...
	{
		name: "Palmolive",
		description: "for hair that is smooth",
		price: 99,
		isActive: true,
		createdOn: new Date().toLocaleString("en-PH", { timeZone: "Asia/Manila" })
	},
	{
		name: "Ps4",
		description: "Ps4 is the new gen",
		price: 50,
		isActive: true,
		createdOn: new Date().toLocaleString("en-PH", { timeZone: "Asia/Manila" })
	},
...
app.post('/create/products', (req, res) => {
 ...
 if (newProducts.createdOn === undefined || newProducts.createdOn === "") {
            newProducts.createdOn = new Date().toLocaleString("en-PH", { timeZone: "Asia/Manila" })
        }
